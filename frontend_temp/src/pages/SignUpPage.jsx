    ...
    <div className="flex h-full items-center justify-center">
      ...
      <div className="flex flex-1 flex-col items-center justify-center h-full px-8">
        ...
        <div className="mb-4">
          ...
          <p className="text-base text-base-content/60 mt-1">
            Join the vibes with a free account!
          </p>
        </div>
      ...
      <div className="hidden lg:flex flex-1 flex-col items-center justify-center bg-base-200 h-full gap-6">
        <div className="text-center text-sm mb-4">
          <p className="text text-3xl font-bold">Join Our Community!</p>
        </div>
        ...
        <div className="text-center  mt-4">
          <p className="text-lg text-base-content/60 w-3/4 mx-auto">
            Connect, chat, and vibe with the people that matter most.
          </p>
        </div>
      </div>
    </div>
